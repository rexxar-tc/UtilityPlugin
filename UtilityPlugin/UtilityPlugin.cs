namespace UtilityPlugin
{
    ...
    public class UtilityPlugin : IPlugin, IChatEventHandler
    {
        ...
        internal static UtilityPlugin Instance;
        ...
        public void Init( )
        {
            ...
            Log.Debug( "Initializing Utility plugin at path {0}\\", Path.GetDirectoryName( Assembly.GetExecutingAssembly( ).Location ) );
        ...
        public void InitWithPath( String modPath )
        {
            ...
            Log.Debug( "Initializing Utility plugin at path {0}\\", Path.GetDirectoryName( modPath ) );
        ...
        private void HandleHelpCommand( ulong remoteUserId, IReadOnlyCollection<string> commandParts )
        {
            if ( commandParts.Count == 1 )
            {
                ...
                string info = string.Format( "Utility Plugin v{0}.  Available Commands: {1}", Version, commandList );
        ...
        public Guid Id
        {
            get
            {
                GuidAttribute guidAttr = (GuidAttribute)typeof( UtilityPlugin ).Assembly.GetCustomAttributes( typeof( GuidAttribute ), true )[0];
        ...
        public Version Version
        {
            get
            {
                return typeof( UtilityPlugin ).Assembly.GetName( ).Version;
            }
        }
